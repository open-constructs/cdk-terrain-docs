...
You can install pre-built providers packaged with the required code bindings for your language or add providers to the [`cdktf.json`](/docs/create-and-deploy/configuration-file) file and generate code bindings manually. To use providers in your application, you can import them from the Terraform Registry or from your local machine.
