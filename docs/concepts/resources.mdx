...
The [examples page](/docs/examples-and-guides/examples) contains multiple example projects for every supported programming language.
...
Refer to the [constructs documentation](/docs/concepts/constructs#scope) for more details and an example.
...
Refer to our [Refactoring Guide](/docs/examples-and-guides/refactoring#moving-renaming-resources-within-a-stack) for more information
