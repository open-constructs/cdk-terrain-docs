...
When data is static or you know the values before [synthesizing your code](/docs/cli-reference/commands#synth), we recommend using loops in your preferred programming language.
