---
title: Project Setup - CDK for Terraform
...
<Tip>Try the [CDK for Terraform Quick Start Demo](/terraform/tutorials/cdktf/cdktf-install) and language-specific [Get Started tutorials](/terraform/tutorials/cdktf).</Tip>
