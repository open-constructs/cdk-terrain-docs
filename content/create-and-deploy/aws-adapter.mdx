---
title: "[deprecated] AWS Adapter"
sidebarTitle: AWS Adapter [archived]
...
1. Set up a CDKTF TypeScript project. Refer to [Project Setup](/create-and-deploy/project-setup) for details.
