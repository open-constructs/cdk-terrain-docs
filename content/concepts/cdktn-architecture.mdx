...
CDKTN [synthesizes](/cli-reference/commands#synth) infrastructure that you define in a supported programming language into [JSON configuration files](/terraform/language/syntax/json) that Terraform or OpenTofu can use to manage infrastructure.
