---
title: Upgrading to CDKTF Version 0.6
sidebarTitle: Upgrading to Version 0.6
description: >-
...
If you cannot upgrade the `cdktf` version, you can switch to [generating provider bindings](/concepts/providers#import-providers) via `cdktf get`.
...
require github.com/open-constructs/cdk-terrain-go/cdktf v0.6.0
```
