...
| `validateFunctionVersions`        | Functions used through `Fn` are validated against the installed Terraform/OpenTofu version. [Learn more](/release/function-availability). |
