---
title: Distributing and Consuming Constructs | CDK Terrain
sidebarTitle: Publishing and Distribution
description: |-
...
Custom construct classes are reusable infrastructure configurations written in a programming language. After you [write a custom construct](/develop-custom-constructs/construct-design), you can translate it to multiple languages and publish it for others to import and use in CDK Terrain (CDKTN) applications.
...
We recommend using the [`cdktn-construct` projen template](https://github.com/projen/projen/blob/main/src/cdktn/cdktn-construct.ts) to package and publish your constructs to either public or private registries. [Projen](https://github.com/projen/projen) synthesizes files and directories into different target languages based on a Javascript or Typescript file. The process is similar to how CDKTN synthesizes code into JSON configuration files for Terraform.
