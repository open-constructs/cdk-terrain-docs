---
title: Build AWS infrastructure with CDK Terrain
description: Provision an AWS EC2 instance with CDKTN in your preferred language, store state in HCP Terraform, then update the stack by adding a Name tag.
---
