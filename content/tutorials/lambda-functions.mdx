---
title: Deploy Lambda functions with TypeScript and CDK Terrain
description: Deploy two AWS Lambda stacks from a single CDKTN app, package Lambda artifacts with TerraformAsset, and manage each stack independently.
---
